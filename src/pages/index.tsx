...
const [recipes, setpeople] = useState<IState[]>([
  {
...
return (
  <Layout>
    ...
    <div className="aboutwidh about-content-backround">
       ...
       <button className="bg-green-400 text-black font-bold py-2 px-4 rounded"> Learn More</button>
    </div>
    </div>
      <div className="aboutimage col-lg-6">
        <div className="about-img">
          <img src="https://i.ibb.co/rvQQWLS/tailwind.png" className="img-fluid w-100 rounded" alt=""/>
          </div>
          </div>   
   </div>
  </div>
